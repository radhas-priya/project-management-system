...
<body>
  ...
  <footer id="footer">
    <div id="slideContainer">
      <div id="slide1">
        <div id="desc">
          <div id="title">PMS</div>
          <div id="details">
            Project Management System is a syystem through which  employees and managers can use for collaboration
            and communication for progression in project and its successful completion.
          </div>
        </div>
        <!-- <div id="socialBtnContainer">
          ...
          <a href="https://www.linkedin.com/in/pras"><i class="fa-brands fa-linkedin"></i></a>
        </div>

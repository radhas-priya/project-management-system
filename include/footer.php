<footer id="footer">
  <div id="slideContainer">
    <div id="slide1">
      <div id="desc">
        <div id="title">Project Management System</div>
        <div id="details">
          Project Management System 
         is a system from which employees and managers can use for integration and cancommunicate together.
        </div>
      </div>
    ...
    <div id="slide2">
      <div id="feedbackFormContainer">
        ...
        <div id="feedback">
          <div id="title">Give your feedback!!</div>
  ...
  <div id="developed">developed by Priya Arya</div>
</footer>